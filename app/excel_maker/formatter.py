...
def format_table():
    ...
    if "Домашние задания" in wb.sheetnames:
        ...
        format_sheet(
            sheet1,
            "92D050",
            {1: (38, True), 2: (147, True), 3: (171, True), 4: (450, False), 5: (105, True)},  # Зеленый цвет
        )
    else:
    ...
    if "Расписание пар" in wb.sheetnames:
        ...
        format_sheet(sheet3, "E6E6FA", {1: (102, True), 2: (178, False), 3: (113, True)})  # Светло-фиолетовый цвет
    else:
