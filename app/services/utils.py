...
async def send_media(chat_id: int, bot: Bot, medias: list[MediaSchema], text: str = None, parse_mode: str = "html"): 
  ...
  for media in medias:
    if media.media_type == "photo":
      media_list.append(InputMediaPhoto(media=media.media))
    elif media.media_type == "video":
      media_list.append(InputMediaVideo(media=media.media))
    elif media.media_type == "audio":
      media_list.append(InputMediaAudio(media=media.media))
    elif media.media_type == "document":
      media_list.append(InputMediaDocument(media=media.media))
    else:
