...
def downgrade() -> None:
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text("timezone('UTC-4'::text, CURRENT_TIMESTAMP)"), autoincrement=False, nullable=False),
    ...
    sa.Column('uid', sa.INTEGER(), server_default=sa.text("nextval('groups_uid_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text("timezone('UTC-4'::text, CURRENT_TIMESTAMP)"), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text("timezone('UTC-4'::text, CURRENT_TIMESTAMP)"), autoincrement=False, nullable=False),
