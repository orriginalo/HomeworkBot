...
async def add_subject_to_subjects(subject: str):
  try:
    ...
    logging.error(f"Error adding subject {subject}: {e}")
    return None
...
async def get_subject_by_name(subject: str):
  try:
    ...
    logging.error(f"Error getting subject by name {subject}: {e}")
    return None
...
async def get_subject_by_id(uid: int):
  try:
    ...
    logging.error(f"Error getting subject by id {uid}: {e}")
    return None