...
def process_subject_name(subject: str, subjects_map: dict, prefixes_map: dict = None) -> str:
    ...
    processed_prefix: str = (
        prefixes_map.get(prefix.lower(), prefix) if (prefixes_map is not None and prefix is not None) else ""
    )
    processed_subject_name: str = (
        subjects_map.get(subject_name.lower(), subject_name) if (subjects_map is not None) else ""
    )
